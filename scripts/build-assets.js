...
async function build () {
  ...
  fse.copySync(ICON, 'public/favicon.ico')
...
function copy () {
  ...
  ].forEach(fontAsset => fse.copySync(path.join(ASSETS_DIR, 'icon-font', fontAsset), `public/fonts/icarus-terminal/${fontAsset}`))

  fse.copySync(path.join(ASSETS_DIR, 'icons'), 'public/icons')
}