...
const SystemStatistics: FunctionComponent<Props> = ({ data }) => {
  ...
  return (
    <div className="border-t border-b border-neutral-800 py-5 tracking-wide text-2xl">
      <div className="flex flex-row align-center justify-between uppercase">
        ...
        <div className="whitespace-nowrap hidden md:inline">
          ...
          {renderBadge(formatNumber(statistics.data.carriers), {
            icon: 'icarus-terminal-location-filled text-5xl'
          })}
        </div>
      </div>
    </div>
