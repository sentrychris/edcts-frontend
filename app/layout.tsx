  ...
  return (
    <html lang="en" data-fx-crt-text="true" className="scroll-smooth">
      <body className={jura.className + " antialiased relative"}>
        ...
        <div className="hidden overlay absolute top-0 inset-x-0 dark:flex justify-center overflow-hidden pointer-events-none">
          <div className="w-[108rem] flex-none flex justify-end">
            <Image
              ...
              height="100"
              src="/avifb.png"
              className="w-[100rem] flex-none max-w-none dark:hidden"
              decoding="async"
              alt="glow"
            ></Image>
            <Image
              ...
              height="100"
              src="/tinyb.png"
              className="w-[150rem] flex-none max-w-none hidden dark:block"
              decoding="async"
              alt="glow"
            ></Image>
          </div>
        ...
        <MainNavigation />
        <main className="flex flex-col px-6 md:px-12 lg:px-24 py-6 mx-auto text-neutral-800 dark:text-neutral-200 text-glow__white">
          <h1 className="uppercase text-4xl mb-5 ">
